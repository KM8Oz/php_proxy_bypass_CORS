<?PHP
isset($_GET['readme']) ? ($_GET['readme'] == 'true' ? 
 print_r('<pre>
 // to see that readme 
...
// Request:
// 
// > proxy.php?url=http://example.com/
// 
// Response:
// 
...
// Request:
// 
// > proxy.php?url=http://example.com/&callback=foo
// 
// Response:
// 
...
:  null ;
  ...
  print_r($jsonp_callback ? "$jsonp_callback($json)" : $json);
